...
const COLUMNS = ['Judul', 'Status', 'Tanggal Publish', 'Author'];
const FIELDS = ['judul', 'status', 'tanggal_publish', 'author'];
const NONE = '__none__';
...
export default function LaporanArtikel({
    jenisLabel,
    data,
    role,
    baseUrl,
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        router.get(`${baseUrl}/laporan/artikel`, params, { preserveScroll: true });
    };
    ...
    const pdfUrl = () => {
        ...
        return `${baseUrl}/laporan/artikel/pdf?${p.toString()}`;
    };
