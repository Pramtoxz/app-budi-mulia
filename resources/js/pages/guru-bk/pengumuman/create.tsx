...
export default function PengumumanCreate() {
    ...
    const handleSubmit = () => {
        form.post(guruBkRoutes.pengumuman.store);
    };
            ...
            <div className="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-muted-foreground">Tulis pengumuman baru untuk siswa</p>
                    </div>
                </div>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Isi data pengumuman</CardDescription>
                    </CardHeader>
