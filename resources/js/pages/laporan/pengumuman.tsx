...
const COLUMNS = ['Judul', 'Prioritas', 'Status', 'Tanggal Publish', 'Tanggal Berlaku'];
const FIELDS = ['judul', 'prioritas', 'status', 'tanggal_publish', 'tanggal_berlaku'];
const NONE = '__none__';
...
export default function LaporanPengumuman({
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        router.get(`${baseUrl}/laporan/pengumuman`, params, { preserveScroll: true });
    };
    ...
    const pdfUrl = () => {
        ...
        return `${baseUrl}/laporan/pengumuman/pdf?${p.toString()}`;
    };
