...
export default function LaporanKelas({
    jenisLabel,
    tahunAjaran,
    data,
    baseUrl,
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        router.get(`${baseUrl}/laporan/kelas`, { tahun_ajaran: localTa }, { preserveScroll: true });
    };

    const pdfUrl = () => {
        if (!tahunAjaran) return '#';
        const p = new URLSearchParams({ tahun_ajaran: tahunAjaran });
        return `${baseUrl}/laporan/kelas/pdf?${p.toString()}`;
    };
