...
const COLUMNS = ['NIS', 'Nama', 'Jenis Kelamin', 'Agama', 'Kelas', 'Status'];
const FIELDS  = ['nis', 'nama', 'jenkel', 'agama', 'kelas', 'status'];
const NONE    = '__none__';
...
export default function LaporanSiswa({
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        router.get(`${baseUrl}/laporan/siswa`, params, { preserveScroll: true });
    };
    ...
    const pdfUrl = () => {
        ...
        return `${baseUrl}/laporan/siswa/pdf?${p.toString()}`;
    };
