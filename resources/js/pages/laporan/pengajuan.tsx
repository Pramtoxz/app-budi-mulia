...
const COLUMNS = ['Tanggal', 'NIS', 'Nama Siswa', 'Kelas', 'Kategori', 'Status', 'Diajukan Oleh'];
const FIELDS = ['tanggal', 'nis', 'nama_siswa', 'kelas', 'kategori', 'status', 'diajukan_oleh'];
const NONE = '__none__';
...
export default function LaporanPengajuan({
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        router.get(`${baseUrl}/laporan/pengajuan`, params, { preserveScroll: true });
    };
    ...
    const pdfUrl = () => {
        ...
        return `${baseUrl}/laporan/pengajuan/pdf?${p.toString()}`;
    };
