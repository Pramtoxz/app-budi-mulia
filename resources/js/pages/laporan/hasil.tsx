...
const COLUMNS = ['Tanggal Hasil', 'NIS', 'Nama Siswa', 'Kelas', 'Kategori', 'Solusi', 'Tindak Lanjut'];
const FIELDS  = ['tanggal_hasil', 'nis', 'nama_siswa', 'kelas', 'kategori', 'solusi', 'tindak_lanjut'];
const NONE    = '__none__';
...
export default function LaporanHasil({
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        router.get(`${baseUrl}/laporan/hasil`, params, { preserveScroll: true });
    };
    ...
    const pdfUrl = () => {
        ...
        return `${baseUrl}/laporan/hasil/pdf?${p.toString()}`;
    };
